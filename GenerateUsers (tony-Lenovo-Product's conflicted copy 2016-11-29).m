...
%         % connection_length < 7 , then make it GM else make it BS
        ...
        % File accessed by each user : random files [1 2 3 4 5]
        FileAccess_Random = randi([1 5],numUsers,1);
        FileAccess_Crowd = randi([1 5],numUsers,1);
...
%         FileAccess_Crowd = ones(numUsers,1);
        ...
        figName = sprintf('Scenario_%d_Users.fig',numUsers);
